<?php
/*
 * Class to ensure compatibility in the transition of WC
 *
 * Version
 * Author:
 * Author URI:
...
class WC_Compat_iPay88
{
    ...
    /**
     * Detect, if we are using WC 2.3+.
     *
     * @since 1.1.2
     *
     * @return bool
     */
    public static function is_wc_2_3()
    {
        if (is_bool(self::$is_wc_2_3)) {
            return self::$is_wc_2_3;
        }

        return self::$is_wc_2_3 = (version_compare(self::get_wc_version_constant(), '2.3', '>='));
    }
    ...
    public static function is_wc_2_4()
    {
        ...
        return self::$is_wc_2_4 = (version_compare(self::get_wc_version_constant(), '2.4', '>='));
    }

    /**
     * Detect, if we are using WC 3.0+.
     *
     * @return bool
     */
    public static function is_wc_3_0()
    {
        ...
        return self::$is_wc_3_0 = (version_compare(self::get_wc_version_constant(), '3.0', '>='));
    }

    /**
     * Detect, if we are using WC 3.1+.
     *
     * @return bool
     */
    public static function is_wc_3_1()
    {
        if (is_bool(self::$is_wc_3_1)) {
            return self::$is_wc_3_1;
        }

        return self::$is_wc_3_1 = (version_compare(self::get_wc_version_constant(), '3.1', '>='));
    }
     ...
     *
     * In 2.4 the WC_Order_Item_Meta class accepts the whole item array.
     *
     * @param array $item
     *
    ...
    public static function wc_get_orders($args)
    {
    ...
    public static function wc_get_order_statuses($format_by = 'term_id')
    {
        if (self::is_wc_2_2()) {
            ...
            $order_statuses = get_terms('shop_order_status', ['hide_empty' => false]);
     ...
     * Since WC 2.3, with or without tax.
     *
     * @since 1.3
     *
     * @param WC_Order $order
    ...
    {
        if (self::is_wc_2_3()) {
            $ex_tax = 'yes' == $order->prices_include_tax ? true : false;
    ...
    public static function api_request_url($request)
    {
        if (self::is_wc_2()) {
            ...
            return $woocommerce->api_request_url($request);
        } else {
