                        ...
                        <tr <?php echo esc_attr( $class_disable ); ?>>
                           ...
                           <td>
                                ...
                                $terms = get_terms(array(
                                 ...
                                 ?>
                               <a href="<?php echo esc_url( admin_url('edit-tags.php?post_type=product&taxonomy='.$slug) ); ?>" title="<?php esc_html_e( 'Manage Taxonomy: Add/Update value of taxonomy', 'ova-brw' ) ?>">
