...
foreach ( $attributes as $attribute ) :
    ...
    if( !empty( $values ) ){ ?>
        ...
        <div class="ovabrw_product_attr">
        	...
        	<span class="label">
        		<?php echo wp_kses_post( wc_attribute_label( $attribute->get_name() ) ); ?> : 
        	</span>

        	<span class="value">
        		<?php echo wp_kses_post( apply_filters( 'woocommerce_attribute',  wptexturize( implode( ', ', $values ) ) , $attribute, $values ) ); ?>
        	<span>
