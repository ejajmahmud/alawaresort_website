			...
			<?php if( $rt_price ){
					...
					foreach ($rt_price as $key => $value) {
						...
						if($rt_price[$key] ) { 
							...
							?>
							<tr class="<?php echo intval($d%2) ? esc_attr( 'eve' ) : esc_attr( 'odd' ); $d++; ?>">
								
								<td class="bold" data-title="<?php esc_attr_e( 'Start Date', 'ova-brw' ); ?>">
									<?php echo esc_html( $date_start ); ?>
								</td>

								<td class="bold"  data-title="<?php esc_attr_e( 'End Date', 'ova-brw' ); ?>">
									<?php echo esc_html( $date_end ); ?>
								</td>
								
								<td data-title="<?php echo sprintf( esc_attr__( 'Price/Day from %1$s - %2$s', 'ova-brw' ), esc_attr( $date_start, $date_end ) ); ?>">
									<?php echo wp_kses_post( wc_price( $rt_price[$key] ) ); ?>
								</td>
										...
										<div class="ovacrs_rt_discount popup" data-popup="popup-ovacrs-rt-discount-day-<?php echo esc_attr( $key ); ?>">
											...
											<div class="popup-inner">
												...
												<div class="price_table">
													...
													<?php $rt_discount_price = isset( $rt_discount[$key]['price'] ) ? $rt_discount[$key]['price'] : '';
																	...
																	foreach ($rt_discount_duration_min as $k => $v) {
																		...
																		if( $rt_discount_duration_type[$k] == 'days' ){ ?>
																			...
																			<tr class="<?php echo intval($n%2) ? esc_attr('eve') : esc_attr('odd'); $n++; ?>">
																				...
																				<td class="bold" data-title="<?php esc_attr_e( 'Min - Max (Days)', 'ova-brw' ); ?>">
																				...
																				<td data-title="<?php echo sprintf( esc_attr__( 'Price/Day from %1$s - %2$s days', 'ova-brw' ), esc_attr($rt_discount_duration_min[$k]), esc_attr( $rt_discount_duration_max[$k] )  ); ?>">
												...
												<div class="close_discount">
													<a class="popup-close-2" data-popup-close="popup-ovacrs-rt-discount-day-<?php echo esc_attr( $key ); ?>" href="#"><?php esc_html_e( 'Close', 'ova-brw' ); ?>
													</a>
												</div>
