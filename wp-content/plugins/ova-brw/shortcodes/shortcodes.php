...
function ovabrw_search( $atts, $content = null ){
    ...
    if ( $attribute_taxonomies ) :
        $html_select_attribute .= '<select name="ovabrw_attribute" class="'.esc_attr( $attribute_required ).'"><option value="">'.esc_html__( 'Select Attribute', 'ova-brw' ).'</option>';
        ...
        if (taxonomy_exists(wc_attribute_taxonomy_name( $tax->attribute_name ) ) ) :
            ...
            $html_select_value_attribute .= '<div class="s_field '.esc_attr( $column ).' ovabrw-value-attribute '.esc_attr( $class_acctive ).'" id="'.esc_attr( $tax->attribute_name ).'"><div class="content"><label>'.esc_html__( 'Value Attribute', 'ova-brw' ).'</label><select name="'.esc_attr( $tax->attribute_name ).'" ><div class="wrap-error"></div>';
            ...
            $term_attributes = get_terms( array(
                'taxonomy'      => wc_attribute_taxonomy_name($tax->attribute_name),
                'orderby'       => 'name',
                'hide_empty'    => false
            ) );

            $html_select_attribute .= "<option ".esc_attr( $checked_name_attr )." value='".esc_attr( $tax->attribute_name )."'>".esc_html( $tax->attribute_label )."</option>";
