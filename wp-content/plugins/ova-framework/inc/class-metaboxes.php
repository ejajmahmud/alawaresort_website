...
if( !class_exists('Entox_Metaboxes') ){
    
    class Entox_Metaboxes {
        ...
        function add(){
            ...
            add_meta_box(
                ...
                apply_filters( 'entox_set_header_version' ,array( 'post', 'page' ) )                  // Post type
            );
        ...
        function general_setting( $post ) {
            ...
            $list_header = apply_filters('entox_list_header', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('entox_list_header', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $list_footer = apply_filters('entox_list_footer', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('entox_list_footer', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $layouts = apply_filters('entox_define_layout', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('entox_define_layout', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $wide_site = apply_filters('entox_define_wide_boxed', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('entox_define_wide_boxed', '') ) : array( 'global' => 'Global' );
            ?>
