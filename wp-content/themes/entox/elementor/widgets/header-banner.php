 ...
 * @since 1.0.0
 */
class Entox_Elementor_Header_Banner extends Widget_Base {
	...
	public function get_name() {
		return 'entox_elementor_header_banner';
	}
	...
	public function get_title() {
		return esc_html__( 'Header Banner', 'entox' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label'        => esc_html__( 'Display Boxed Content', 'entox' ),
			...
			$this->add_control(
				'header_bg_source',
				[
					'label'        => esc_html__( 'Display Background by Feature Image in Post/Page', 'entox' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'no'
				]
			);
			...
			$this->add_control(
				'cover_color',
				[
					'label' => esc_html__( 'Background Cover Color', 'entox' ),
					'type' => Controls_Manager::COLOR,
					'default' => 'rgba(0,0,0,0.51)',
					'description' => esc_html__( 'You can add background image in Advanced Tab', 'entox' ),
					'selectors' => [
			...
			$this->add_control(
				'show_title',
				[
					'label'        => esc_html__( 'Show Title', 'entox' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'yes',
			...
			$this->add_control(
				'title_color',
				[
					'label' => esc_html__( 'Title Color', 'entox' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_responsive_control(
				'title_padding',
				[
					'label' => esc_html__( 'Title Padding', 'entox' ),
			...
			$this->add_control(
				'title_tag',
				[
					'label' => esc_html__( 'Choose Title Format', 'entox' ),
					'type' => Controls_Manager::SELECT,
					'options' => [
						'h1' => esc_html__('H1', 'entox'),
						'h2' => esc_html__('H2', 'entox'),
						'h3' => esc_html__('H3', 'entox'),
						'h4' => esc_html__('H4', 'entox'),
						'h5' => esc_html__('H5', 'entox'),
						'h6' => esc_html__('H6', 'entox'),
						'div' => esc_html__('DIV', 'entox'),
					],
					'default' => 'h1'
				]
			);
			...
			$this->add_group_control(
				...
				[
					'name' => 'header_title',
					'label' => esc_html__( 'Title Typo', 'entox' ),
					'global' => [
			...
			$this->add_control(
				'show_breadcrumbs',
				[
					'label'        => esc_html__( 'Show Breadcrumbs', 'entox' ),
					'type'         => Controls_Manager::SWITCHER,
					'default'      => 'yes',
			...
			$this->add_control(
				'breadcrumbs_color',
				[
					'label' => esc_html__( 'Breadcrumbs Color', 'entox' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Breadcrumbs Color hover', 'entox' ),
					'type' => Controls_Manager::COLOR,
					'default' => '#343434',
					'selectors' => [
			...
			$this->add_group_control(
				...
				[
					...
					'label' => esc_html__( 'Breadcrumbs Typography', 'entox' ),
					'global' => [
						'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Typography::TYPOGRAPHY_TEXT,
					],
			...
			$this->add_responsive_control(
				'breadcrumbs_padding',
				[
					'label' => esc_html__( 'Breadcrumbs Padding', 'entox' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
	...
	protected function render() {
		...
		$align = isset( $settings['align'] ) ? $settings['align'] : '';
		 ...
		 ?>
		 	...
		 	<div class="wrap_header_banner <?php echo esc_attr($class_bg).' '.$align; ?> " <?php echo esc_attr( $attr_style ); ?> >
		 		...
		 		<?php if( $settings['header_boxed_content'] == 'yes' ){ ?><div class="row_site"><div class="container_site"><?php } ?>
					...
					<div class="header_banner_el <?php echo esc_attr( $settings['class'] ); ?>">
						...
						<?php if( $settings['show_title'] == 'yes' ){ ?>
							...
							<?php add_filter( 'entox_show_singular_title', '__return_false' ); ?>
...
$widgets_manager->register( new Entox_Elementor_Header_Banner() );