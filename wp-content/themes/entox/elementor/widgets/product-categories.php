...
class Entox_Elementor_Product_Categories extends Widget_Base {

	public function get_name() {
		return 'entox_elementor_product_categories';
	}

	public function get_title() {
		return esc_html__( 'Product Categories', 'entox' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-product-categories .items .item a .item-content',
					'separator' => 'before',
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', '%', 'em' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ova-product-categories .items .item a .item-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', '%', 'em' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ova-product-categories .items .item a .item-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			'section_product_categories_image_style',
			[
			...
			$this->add_responsive_control(
				'product_categories_image_width',
				[
					...
					'selectors' => [
						'{{WRAPPER}} .ova-product-categories .items .item .image img' => 'width: {{SIZE}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-product-categories .items .item a .item-content .count-product .count .number',
				]
			);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'selectors' => [
								'{{WRAPPER}} .ova-product-categories .items .item a .item-content .count-product .count .number' => 'color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-product-categories .items .item a .item-content .count-product .count .number' => 'background-color: {{VALUE}}',
							],
						]
					);
				...
				$this->start_controls_tab(
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-product-categories .items .item a:hover .item-content .count-product .count .number' => 'color: {{VALUE}}',
							],
						]
					);
					...
					$this->add_control(
						...
						[
							...
							'type' 		=> Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .ova-product-categories .items .item a:hover .item-content .count-product .count .number' => 'background-color: {{VALUE}}',
							],
						]
					);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', '%', 'em' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ova-product-categories .items .item a .item-content .count-product' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
		...
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' 	=> '{{WRAPPER}} .ova-product-categories .items .item .title',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'type' 		=> Controls_Manager::COLOR,
					'selectors' => [
						'{{WRAPPER}} .ova-product-categories .items .item .title' => 'color: {{VALUE}}',
					],
				]
			);
			...
			$this->add_responsive_control(
				...
				[
					...
					'size_units' 	=> [ 'px', '%', 'em' ],
					'selectors' 	=> [
						'{{WRAPPER}} .ova-product-categories .items .item .title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					],
				]
			);
	...
	protected function render() {
		...
		<?php if ( $categories && is_array( $categories ) ): ?>
			<div class="ova-product-categories">
				<div class="items">
...
$widgets_manager->register( new Entox_Elementor_Product_Categories() );
