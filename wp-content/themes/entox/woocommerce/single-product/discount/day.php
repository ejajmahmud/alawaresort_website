...
<?php if ( $rt_price ): ?>
	<div class="table-price">
		<div class="head-label">
			...
			<h3 class="label"><?php esc_html_e( 'Price/Day', 'entox' ); ?></h3>
			<h3 class="label"><?php esc_html_e( 'Special Discount', 'entox' ); ?></h3>
		</div>
		<div class="boby-price">
			<?php foreach( $rt_price as $k => $value ): 
				...
				<div class="table-discount <?php echo esc_attr( $data_discount ); ?>">
					...
					?>
						<table class="head-discount">
							<thead>
								<tr>
									<th class="head-discount-label"><?php esc_html_e( 'Min - Max (Days)', 'entox' ); ?></th>
									<th class="head-discount-label"><?php esc_html_e( 'Price/Days', 'entox' ); ?></th>
								</tr>
							</thead>
							<tbody>
								<?php foreach( $rt_discount_duration_min as $i => $discount_duratio ): ?>
									<?php if ( $rt_discount_duration_type[$i] == 'days' ): 
